...
public final class SupportThreadApi
{
    private final AprilFlowHttpClient httpClient;
    private final JsonSerializer jsonSerializer;

    public SupportThreadApi(AprilFlowHttpClient httpClient, JsonSerializer jsonSerializer)
    {
    ...
    public String create(CreateSupportThreadRequest request)
    {
        HttpResponse response;

        response = ApiResponseHandler.requireSuccess(
            httpClient.execute(
                ApiRequest.post("/message/v1/pub/threads/support")
